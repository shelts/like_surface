...
set key off
set output '2D_like_surface/plots_2d/rr_mr.png' 
...
unset colorbox
splot './2D_like_surface/likelihood_data_2d/rr_mr_data_vals.txt' using 1:2:3 with image
...
set dgrid3d 5,5 5
plot  './2D_like_surface/likelihood_data_2d/cons_den.txt' using 1:2:3 with points ps 0.1 pt 5 lc 'grey', './2D_like_surface/likelihood_data_2d/best_fit.txt' using 2:3:1 with points ps 2 pt 11  palette, './2D_like_surface/likelihood_data_2d/correct_answer.txt' using 2:3:1 with points ps 5 pt 3  palette
# lc rgb 'black'
